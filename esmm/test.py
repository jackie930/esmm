...
for i in range(len(data_df)):
    ...
    # add label
    features[columns_nm_list[26]] = tf.train.Feature(float_list=tf.train.FloatList(value=[data_df[columns_nm_list[26]][i]]))
    features[columns_nm_list[27]] = tf.train.Feature(float_list=tf.train.FloatList(value=[data_df[columns_nm_list[27]][i]]))
