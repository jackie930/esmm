...
def create_feature_columns():
    # user feature
    uid = fc.indicator_column(fc.categorical_column_with_hash_bucket("uid", 1000))

    # item feature
    room_id = fc.indicator_column(fc.categorical_column_with_hash_bucket("room_id", 1000))
    anchor_level = fc.numeric_column("anchor_level", default_value=0.0)
    anchor_score = fc.numeric_column("anchor_score", default_value=0.0)
    is_top200_anchor = fc.numeric_column("is_top200_anchor", default_value=0.0)
    room_click_num_1_day = fc.numeric_column("room_click_num_1_day", default_value=0.0)
    room_click_num_7_day = fc.numeric_column("room_click_num_7_day", default_value=0.0)
    ...
    my_feature_columns = [uid, room_id, anchor_level, anchor_score, is_top200_anchor, room_click_num_1_day, room_click_num_7_day]
    my_label_feature_columns = [uid, room_id, anchor_level, anchor_score, is_top200_anchor, room_click_num_1_day, room_click_num_7_day, click, pay]
